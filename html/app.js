...
const app = Vue.createApp({
  ...
  watch: {
    ...
    isCompassFollowChecked: function () {
      localStorage.setItem(
        "isCompassFollowChecked",
        this.isCompassFollowChecked
      );
    },
    isOpenMenuSoundsChecked: function () {
      localStorage.setItem(
        "isOpenMenuSoundsChecked",
        this.isOpenMenuSoundsChecked
      );
    },
    ...
    isCinematicNotifChecked: function () {
      localStorage.setItem(
        ...
        this.isCinematicNotifChecked
      );
    },
    isDynamicHealthChecked: function () {
      localStorage.setItem(
        "isDynamicHealthChecked",
        this.isDynamicHealthChecked
      );
    },
    ...
    isDynamicHungerChecked: function () {
      localStorage.setItem(
        "isDynamicHungerChecked",
        this.isDynamicHungerChecked
      );
    },
    isDynamicThirstChecked: function () {
      localStorage.setItem(
        "isDynamicThirstChecked",
        this.isDynamicThirstChecked
      );
    },
    isDynamicStressChecked: function () {
      localStorage.setItem(
        "isDynamicStressChecked",
        this.isDynamicStressChecked
      );
    },
    isDynamicOxygenChecked: function () {
      localStorage.setItem(
        "isDynamicOxygenChecked",
        this.isDynamicOxygenChecked
      );
    },
    ...
    isToggleMapShapeChecked: function () {
      localStorage.setItem(
        "isToggleMapShapeChecked",
        this.isToggleMapShapeChecked
      );
    },
    ...
    isToggleMapBordersChecked: function () {
      localStorage.setItem(
        "isToggleMapBordersChecked",
        this.isToggleMapBordersChecked
      );
    },
    isDynamicEngineChecked: function () {
      localStorage.setItem(
        "isDynamicEngineChecked",
        this.isDynamicEngineChecked
      );
    },
    ...
    isChangeCompassFPSChecked: function () {
      localStorage.setItem(
        "isChangeCompassFPSChecked",
        this.isChangeCompassFPSChecked
      );
    },
  ...
  mounted() {
    this.listener = window.addEventListener("message", (event) => {
      if (
        event.data.event === "isToggleMapShapeChecked" ||
        event.data.event === "isChangeFPSChecked"
      ) {
...
function closeMenu() {
  ...
  $.post("https://bd-hud/closeMenu");
}
function restartHud() {
  closeMenu();
  $.post("https://bd-hud/restartHud");
}
function resetStorage() {
  closeMenu();
  $.post("https://bd-hud/resetStorage");
}
function showOutMap() {
  $.post("https://bd-hud/showOutMap");
}
function showOutCompass() {
  $.post("https://bd-hud/showOutCompass");
}
function showFollowCompass() {
  $.post("https://bd-hud/showFollowCompass");
}
function openMenuSounds() {
  $.post("https://bd-hud/openMenuSounds");
}
function resetHudSounds() {
  $.post("https://bd-hud/resetHudSounds");
}
function checklistSounds() {
  $.post("https://bd-hud/checklistSounds");
}
function showMapNotif() {
  $.post("https://bd-hud/showMapNotif");
}
function showFuelAlert() {
  $.post("https://bd-hud/showFuelAlert");
}
function showCinematicNotif() {
  $.post("https://bd-hud/showCinematicNotif");
}
function dynamicHealth() {
  $.post("https://bd-hud/dynamicHealth");
}
function dynamicArmor() {
  $.post("https://bd-hud/dynamicArmor");
}
function dynamicHunger() {
  $.post("https://bd-hud/dynamicHunger");
}
function dynamicThirst() {
  $.post("https://bd-hud/dynamicThirst");
}
function dynamicStress() {
  $.post("https://bd-hud/dynamicStress");
}
function dynamicOxygen() {
  $.post("https://bd-hud/dynamicOxygen");
}
function dynamicEngine() {
  $.post("https://bd-hud/dynamicEngine");
}
function dynamicNitro() {
  $.post("https://bd-hud/dynamicNitro");
}
function ToggleMapShape() {
  $.post("https://bd-hud/ToggleMapShape");
}
function changeFPS() {
  $.post("https://bd-hud/changeFPS");
}
function ToggleMapBorders() {
  $.post("https://bd-hud/ToggleMapBorders");
}
function HideMap() {
  $.post("https://bd-hud/HideMap");
}
function changeCompassFPS() {
  $.post("https://bd-hud/changeCompassFPS");
}
function showCompassBase() {
  $.post("https://bd-hud/showCompassBase");
}
function showStreetsNames() {
  $.post("https://bd-hud/showStreetsNames");
}
function showPointerIndex() {
  $.post("https://bd-hud/showPointerIndex");
}
function showDegreesNum() {
  $.post("https://bd-hud/showDegreesNum");
}
function cinematicMode() {
  $.post("https://bd-hud/cinematicMode");
}
...
const playerHud = {
  data() {
    return {
      ...
      showParachute: false,
      showDev: false,
      voiceIcon: "./icons/microphone.png",
      talkingColor: "#38a2e5",
      nosColor: "",
      engineColor: "",
      armorColor: "",
  ...
  methods: {
    hudTick(data) {
      ...
      if (data.hunger >= 100) {
        this.hungerColor = ref("#dd6e14");
      } else if (data.hunger <= 30) {
        this.hungerColor = ref("#ff0000");
      } else {
        this.hungerColor = ref("#dd6e14");
      }
      ...
      if (data.radioActive) {
        ...
        this.talkingColor = "#246f9e";
      } else {
        this.talkingColor = "#38a2e5";
      }
      if (data.radio != 0 && data.radio != undefined) {
        this.voiceIcon = "./icons/earphones.png";
      } else if (data.radio == 0 || data.radio == undefined) {
        this.voiceIcon = "./icons/microphone.png";
      }
      if (data.cruise === true) {
        this.cruise = 1;
...
const vehHud = {
  ...
  methods: {
    vehicleHud(data) {
      this.show = data.show;
      this.speed = data.speed.toString().padStart(3, "0");
      this.gear = data.gear;
      this.rpm = data.rpm;
      this.altitude = data.altitude;
      this.fuel = data.fuel.toFixed(0);
      this.engine = data.engine.toFixed(0);
      ...
      if (data.seatbelt === true) {
        this.seatbelt = 1;
        this.seatbeltColor = "yellowgreen";
      } else {
        this.seatbelt = 0;
    ...
    this.listener = window.addEventListener("message", (event) => {
      if (event.data.action == "update") {
        ...
        if (value !== undefined) {
          ...
          this.direction = getDirection(Number(value));
        }
      }
